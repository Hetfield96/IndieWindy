...
namespace WebAPI.Migrations
{
    ...
    [Migration("20200226174554_AddedToContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.ArtistConcertLink", b =>
                {
                    b.Property<int>("ArtistId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI.Models.UserAlbumLink", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Models.UserArtistLink", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI.Models.UserConcertLink", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI.Models.UserSongLink", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebAPI.Models.Song", b =>
                {
                    b.HasOne("WebAPI.Models.Artist", "Album")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPI.Models.UserSongLink", b =>
                {
                    ...
                    b.HasOne("WebAPI.Models.Song", "Song")
                        .WithMany()
